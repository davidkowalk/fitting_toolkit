...
> Note that, while most sources on this list are available through [Library Genesis](https://libgen.is) or [SciHub](https://scihub.help/scihub-proxy-mirror-links-websites) the websites breache copyright and thus using the ISBN or DOI to search for a book there can not be recommended.
